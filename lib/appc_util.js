...
class AppcUtil {
	...
	**/
	...
	/**
		...
		@param {Function} done - can either be a generaic or a promise callback
	**/
	...
	/**
		...
		NOTE: Parameters are same as runBuild().
	**/
	static buildOnly(projDir, platform, spawnHandler, done) {
		const thisArgs = Array.from(arguments);
