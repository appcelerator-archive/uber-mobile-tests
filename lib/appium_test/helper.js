...
const
	ConfigTests = require('../../appium_tests/test_config.js').tests,
	ConfigServer = require('../../appium_tests/test_config.js').server;
...
const TEST_DIR = path.join(__dirname, '..', '..', 'appium_tests');
...
let
	_playerPid = -1,
	_ranAlready = '',
	_appiumProc = null; // will be assigned a ChildProcess object;
...
*/
function _buildTestApps(suites, tiSdk, moreLogs, done) {
